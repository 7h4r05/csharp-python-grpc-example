...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Random = channel.unary_unary(
                ...
                request_serializer=calculator__pb2.RandomRequest.SerializeToString,
                response_deserializer=calculator__pb2.RandomReply.FromString,
                )
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Random': grpc.unary_unary_rpc_method_handler(
                    servicer.Random,
                    request_deserializer=calculator__pb2.RandomRequest.FromString,
                    response_serializer=calculator__pb2.RandomReply.SerializeToString,
            ),
    }
...
class Calculator(object):
    ...
    def Random(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calculator.Calculator/Random',
            calculator__pb2.RandomRequest.SerializeToString,
            calculator__pb2.RandomReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
